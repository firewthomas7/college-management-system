            ...
            <form action="{{ route('admin.subjects.update', $subject) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <x-text-input id="name" type="text" name="name" :value="old('name', $subject->name)" required autofocus />
                        <x-input-error :messages="$errors->get('name')" />
                    </div>

                    <div class="col-md-4 mb-3">
                        <x-input-label for="code" value="Subject Code" />
                        <x-text-input id="code" type="text" name="code" :value="old('code', $subject->code)" required />
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <x-text-input id="year_level" type="number" name="year_level" :value="old('year_level', $subject->year_level)" min="1" max="7" required />
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select id="semester_number" name="semester_number" class="form-select" required>
                            <option value="1" @selected(old('semester_number', $subject->semester_number) == 1)>Semester 1</option>
                            <option value="2" @selected(old('semester_number', $subject->semester_number) == 2)>Semester 2</option>
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <x-text-input id="credit_hours" type="number" name="credit_hours" :value="old('credit_hours', $subject->credit_hours)" min="1" max="10" required />
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="3">{{ old('description', $subject->description) }}</textarea>
