<x-layouts.dashboard title="Edit Department">
    <x-slot:sidebar>
        <li class="nav-item">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <h5 class="fw-bold mb-4">Edit Department</h5>
            ...
            <form action="{{ route('admin.departments.update', $department) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-8 mb-3">
                        ...
                        <x-text-input id="name" type="text" name="name" :value="old('name', $department->name)" required autofocus />
                        <x-input-error :messages="$errors->get('name')" />
                    </div>

                    <div class="col-md-4 mb-3">
                        <x-input-label for="code" value="Department Code" />
                        <x-text-input id="code" type="text" name="code" :value="old('code', $department->code)" required />
